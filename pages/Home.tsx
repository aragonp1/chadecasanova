  ...
  return (
    <div className="flex flex-col items-center animate-fade-in">
      <header className="w-full text-center flex flex-col items-center mb-8">
        <div className="mb-4 absolute inset-0 bg-cover bg-center relative w-full" style={{ backgroundImage: `url('https://i.ibb.co/LzGdb9Hp/b9067b33984ae88ed69cdb4b04bbb614.jpg')` }}>
